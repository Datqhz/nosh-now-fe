...
import 'package:management_app/data/responses/update_order_status_response.dart';
...
class OrderRepository {
  ...
  Future<List<GetOrdersData>?> updatePrepareStatus(
    ...
    try {
      Response response = await get(
          Uri.parse(
              "${GlobalVariable.url}/order/api/v1/OrderDetal/Employee-GetByStatus?status=${request.orderStatus}"),
          headers: headers);
