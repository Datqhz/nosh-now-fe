...
import 'package:management_app/presentation/widget/food_management_item.dart';
...
class _FoodManagementScreenState extends State<FoodManagementScreen> {
  ...
  void initState() {
    ...
    Provider.of<FoodListProvider>(context, listen: false)
        .fetchFoods(GlobalVariable.profile!.id, context);
  }
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    FoodData? temp = await Navigator.push(
                        context,
                        MaterialPageRoute(
